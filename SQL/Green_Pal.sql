...
--INSERT INTO `usuarios`(`usr_nombre`, `usr_email`, `usr_depto`, `registro_fecha`)
--SELECT 
--    CONCAT('usr_nombre', FLOOR(RAND() * 10000)),        
--    CONCAT('usr_email', FLOOR(RAND() * 10000), '@test.com'),
--    CONCAT('usr_depto', FLOOR(RAND() * 10000)), 
