...
$transactions_sql = "SELECT * FROM solicitudes_recoleccion WHERE estatus LIKE 'Completa' ORDER BY fecha_registro ASC";
...
>
  <head>
    ...
    <title>Solicitudes completas</title>
        ...
        <div class="hero-body">
          <div class="level">
            <div class="level-left">
              <div class="level-item"><h1 class="title">Solicitudes completas</h1></div>
            </div>
